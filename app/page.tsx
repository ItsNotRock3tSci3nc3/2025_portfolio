    ...
    <section>
      ...
      <p className="mb-4">
        I am a student at the University of Missouri – Columbia, pursuing a Bachelor’s degree in Information Technology with a minor in Computational Neuroscience.
          ...
          <br />
          Feel free to explore my <a href="https://github.com/ItsNotRock3tSci3nc3" target="_blank" rel="noopener noreferrer"><span className="underline">GitHub</span></a> and view my <a href="/2025_portfolio/resume.pdf" target="_blank" rel="noopener noreferrer">Resume
                                                                                                                                                                                      </a><span className="underline">resume</span></a> to learn more about my work.
          <br />
